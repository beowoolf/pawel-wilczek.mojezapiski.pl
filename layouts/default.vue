  ...
  <div class="d-flex flex-column h-100">
    <header>
      ...
      <b-navbar toggleable="md" type="dark" variant="dark" class="fixed-top">
        <b-navbar-brand to="/" title="O mnie"><logo /></b-navbar-brand>

        <b-navbar-toggle target="nav-collapse"></b-navbar-toggle>

        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav class="ml-auto">
            <b-nav-item to="/" :link-attrs="{ title: 'O mnie' }"
              >O mnie</b-nav-item
            >
            <b-nav-item-dropdown
              :link-attrs="{ title: 'Moje kwalifikacje' }"
              text="Moje kwalifikacje"
            >
              <b-dropdown-item
                v-for="{ link, name } in platforms.internal"
                :key="link"
                :to="link"
                :title="name"
              ...
              >
              <b-dropdown-item
                v-for="{ link, name } in platforms.external"
                :key="link"
                :href="link"
                :title="name"
                rel="nofollow"
            ...
            <b-nav-item-dropdown
              text="Ja w Social Mediach"
              :link-attrs="{ title: 'Ja w Social Mediach' }"
            >
              <b-dropdown-item
